...
use async_vault_client::{
    ...
    RejectRequestBuilder, Request, RequestArgs, RequestState,
    SkipCanceledSubscriptionRequestBuilder, UpdateVaultNavBuilder, Vault,
};
use litesvm::LiteSVM;
...
fn skip_canceled_subscription_request(
    ...
    SkipCanceledSubscriptionRequestBuilder::new()
        .vault(vault_pubkey)
        .request(request_pubkey)
        .owner(owner)
        .instruction()
