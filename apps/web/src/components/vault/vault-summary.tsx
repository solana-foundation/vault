        ...
        <Card className="overflow-hidden">
            <div className="relative bg-gradient-to-br from-primary/15 via-transparent to-solana-green/10 px-6 py-5">
                ...
                <div className="mt-2 flex flex-wrap items-center gap-2">
                    <AddressPill value={vault.shareMint} label="share" chars={6} />
                    <AddressPill value={base.assetMint} label="asset" chars={6} />
                    <AddressPill value={base.authority} label="authority" chars={6} />
                    {base.pendingAuthority.__option === 'Some' ? (
                        <AddressPill value={base.pendingAuthority.value} label="pending" chars={6} />
                    ) : null}
                </div>
            </div>
