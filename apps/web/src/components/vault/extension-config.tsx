...
import { EXTENSION_DESCRIPTIONS, EXTENSION_LABELS, ExtensionType, type ExtensionTypeValue } from '@/lib/extensions';
...
export const DEFAULT_EXT_CONFIG: ExtensionsConfig = {
    depositFee: { bps: 50, enabled: false },
    ...
    withdrawalFee: { bps: 50, enabled: false },
};
