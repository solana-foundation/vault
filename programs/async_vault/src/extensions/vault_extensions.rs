...
pub const MAX_PAUSABLE_DATA_SIZE: usize = 1;
pub const PAUSABLE_TLV_SIZE: usize = TLV_HEADER_SIZE + MAX_PAUSABLE_DATA_SIZE;
...
pub enum ExtensionType {
    DepositFee = 1,
    WithdrawalFee = 2,
    PausableSubcriptionsExtension = 3,
    PausableRedemptionsExtension = 4,
}
...
impl ExtensionType {
    pub fn try_from_u16(value: u16) -> Option<Self> {
        match value {
            ...
            3 => Some(Self::PausableSubcriptionsExtension),
            4 => Some(Self::PausableRedemptionsExtension),
            _ => None,
        }
    }
    ...
    pub fn data_len(&self) -> usize {
        match self {
            ...
            Self::PausableSubcriptionsExtension | Self::PausableRedemptionsExtension => {
                MAX_PAUSABLE_DATA_SIZE
            }
        }
    }
