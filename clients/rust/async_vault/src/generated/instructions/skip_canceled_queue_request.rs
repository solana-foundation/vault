...
pub const SKIP_CANCELED_QUEUE_REQUEST_DISCRIMINATOR: [u8; 8] = [57, 98, 74, 205, 33, 46, 89, 166];

/// Accounts.
#[derive(Debug)]
pub struct SkipCanceledQueueRequest {
...
impl SkipCanceledQueueRequest {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let data = SkipCanceledQueueRequestInstructionData::new()
            .try_to_vec()
            .unwrap();
...
pub struct SkipCanceledQueueRequestInstructionData {
    discriminator: [u8; 8],
}

impl SkipCanceledQueueRequestInstructionData {
    pub fn new() -> Self {
        Self {
            discriminator: [57, 98, 74, 205, 33, 46, 89, 166],
        }
    }
...
impl Default for SkipCanceledQueueRequestInstructionData {
    fn default() -> Self {
        Self::new()
    }
}

/// Instruction builder for `SkipCanceledQueueRequest`.
///
/// ### Accounts:
///
///   0. `[writable]` vault
...
pub struct SkipCanceledQueueRequestBuilder {
...
impl SkipCanceledQueueRequestBuilder {
    pub fn new() -> Self {
        Self::default()
    }
    ...
    pub fn instruction(&self) -> solana_instruction::Instruction {
        let accounts = SkipCanceledQueueRequest {
...
/// `skip_canceled_queue_request` CPI accounts.
pub struct SkipCanceledQueueRequestCpiAccounts<'a, 'b> {
...
/// `skip_canceled_queue_request` CPI instruction.
pub struct SkipCanceledQueueRequestCpi<'a, 'b> {
...
impl<'a, 'b> SkipCanceledQueueRequestCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_account_info::AccountInfo<'a>,
        accounts: SkipCanceledQueueRequestCpiAccounts<'a, 'b>,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `SkipCanceledQueueRequest` via CPI.
///
/// ### Accounts:
///
///   0. `[writable]` vault
...
///   3. `[]` system_program
#[derive(Clone, Debug)]
pub struct SkipCanceledQueueRequestCpiBuilder<'a, 'b> {
    instruction: Box<SkipCanceledQueueRequestCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> SkipCanceledQueueRequestCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(SkipCanceledQueueRequestCpiBuilderInstruction {
            __program: program,
            vault: None,
            request: None,
            owner: None,
    ...
    #[allow(clippy::vec_init_then_push)]
    pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_error::ProgramResult {
        let instruction = SkipCanceledQueueRequestCpi {
...
#[derive(Clone, Debug)]
struct SkipCanceledQueueRequestCpiBuilderInstruction<'a, 'b> {
