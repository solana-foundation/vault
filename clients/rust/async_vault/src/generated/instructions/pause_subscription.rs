...
pub const PAUSE_SUBSCRIPTION_DISCRIMINATOR: [u8; 8] = [18, 180, 147, 157, 114, 60, 213, 241];
...
impl PauseSubscription {
    pub fn instruction(
        &self,
        args: PauseSubscriptionInstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = PauseSubscriptionInstructionData::new()
            .try_to_vec()
            .unwrap();
...
pub struct PauseSubscriptionInstructionData {
    discriminator: [u8; 8],
}

impl PauseSubscriptionInstructionData {
    pub fn new() -> Self {
        Self {
            discriminator: [18, 180, 147, 157, 114, 60, 213, 241],
        }
    }
...
impl Default for PauseSubscriptionInstructionData {
    fn default() -> Self {
        Self::new()
    }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct PauseSubscriptionInstructionArgs {
    pub paused: bool,
}

impl PauseSubscriptionInstructionArgs {
    pub(crate) fn try_to_vec(&self) -> Result<Vec<u8>, std::io::Error> {
        borsh::to_vec(self)
    }
}

/// Instruction builder for `PauseSubscription`.
///
/// ### Accounts:
///
///   0. `[signer]` authority
...
pub struct PauseSubscriptionBuilder {
...
/// `pause_subscription` CPI accounts.
pub struct PauseSubscriptionCpiAccounts<'a, 'b> {
...
/// `pause_subscription` CPI instruction.
pub struct PauseSubscriptionCpi<'a, 'b> {
    ...
    pub __args: PauseSubscriptionInstructionArgs,
}

impl<'a, 'b> PauseSubscriptionCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_account_info::AccountInfo<'a>,
        accounts: PauseSubscriptionCpiAccounts<'a, 'b>,
        args: PauseSubscriptionInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `PauseSubscription` via CPI.
///
/// ### Accounts:
///
///   0. `[signer]` authority
...
///   2. `[writable]` vault
#[derive(Clone, Debug)]
pub struct PauseSubscriptionCpiBuilder<'a, 'b> {
    instruction: Box<PauseSubscriptionCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> PauseSubscriptionCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(PauseSubscriptionCpiBuilderInstruction {
            __program: program,
            authority: None,
            share_mint: None,
            vault: None,
    ...
    pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_error::ProgramResult {
        ...
        let instruction = PauseSubscriptionCpi {
...
#[derive(Clone, Debug)]
struct PauseSubscriptionCpiBuilderInstruction<'a, 'b> {
