...
impl CancelRequestBuilder {
    ...
    /// `[optional account]`
    #[inline(always)]
    pub fn user_share_token_account(
        &mut self,
        user_share_token_account: Option<solana_pubkey::Pubkey>,
    ) -> &mut Self {
        self.user_share_token_account = user_share_token_account;
        self
    }
...
impl<'a, 'b> CancelRequestCpiBuilder<'a, 'b> {
    ...
    pub fn user_share_token_account(
        ...
        self.instruction.user_share_token_account = user_share_token_account;
        self
    }
