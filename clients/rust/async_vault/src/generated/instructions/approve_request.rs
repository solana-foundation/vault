...
pub const APPROVE_REQUEST_DISCRIMINATOR: [u8; 8] = [89, 68, 167, 104, 93, 25, 178, 205];
...
impl ApproveRequest {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let data = ApproveRequestInstructionData::new().try_to_vec().unwrap();
...
pub struct ApproveRequestInstructionData {
    discriminator: [u8; 8],
}

impl ApproveRequestInstructionData {
    pub fn new() -> Self {
        Self {
...
impl Default for ApproveRequestInstructionData {
    fn default() -> Self {
        Self::new()
    }
}

/// Instruction builder for `ApproveRequest`.
///
/// ### Accounts:
///
///   0. `[signer]` authority
...
/// `approve_request` CPI instruction.
pub struct ApproveRequestCpi<'a, 'b> {
...
impl<'a, 'b> ApproveRequestCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_account_info::AccountInfo<'a>,
        accounts: ApproveRequestCpiAccounts<'a, 'b>,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `ApproveRequest` via CPI.
///
/// ### Accounts:
///
///   0. `[signer]` authority
...
impl<'a, 'b> ApproveRequestCpiBuilder<'a, 'b> {
    ...
    #[allow(clippy::vec_init_then_push)]
    pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_error::ProgramResult {
        let instruction = ApproveRequestCpi {
