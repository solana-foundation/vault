...
pub const EXECUTE_WITHDRAW_DISCRIMINATOR: [u8; 8] = [183, 103, 2, 112, 90, 138, 96, 109];
...
impl ExecuteWithdraw {
  pub fn instruction(&self, args: ExecuteWithdrawInstructionArgs) -> solana_instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: ExecuteWithdrawInstructionArgs, remaining_accounts: &[solana_instruction::AccountMeta]) -> solana_instruction::Instruction {
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct ExecuteWithdrawInstructionData {
            discriminator: [u8; 8],
            }

impl ExecuteWithdrawInstructionData {
  pub fn new() -> Self {
    Self {
                        discriminator: [183, 103, 2, 112, 90, 138, 96, 109],
                                }
  }
...
impl Default for ExecuteWithdrawInstructionData {
  fn default() -> Self {
    Self::new()
  }
}
...
pub struct ExecuteWithdrawBuilder {
...
#[inline(always)]
  ...
  pub fn instruction(&self) -> solana_instruction::Instruction {
    let accounts = ExecuteWithdraw {
          ...
          let args = ExecuteWithdrawInstructionArgs {
                                                              withdraw_amount: self.withdraw_amount.clone().expect("withdraw_amount is not set"),
                                    };
  ...
  /// `execute_withdraw` CPI accounts.
  pub struct ExecuteWithdrawCpiAccounts<'a, 'b> {
...
/// `execute_withdraw` CPI instruction.
pub struct ExecuteWithdrawCpi<'a, 'b> {
...
/// Instruction builder for `ExecuteWithdraw` via CPI.
///
/// ### Accounts:
///
                ///   0. `[signer]` signer
          ...
          ///   6. `[]` associated_protocols_info
#[derive(Clone, Debug)]
pub struct ExecuteWithdrawCpiBuilder<'a, 'b> {
  instruction: Box<ExecuteWithdrawCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> ExecuteWithdrawCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
    let instruction = Box::new(ExecuteWithdrawCpiBuilderInstruction {
      __program: program,
              signer: None,
              share_mint: None,
              extra_metas: None,
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_error::ProgramResult {
          let args = ExecuteWithdrawInstructionArgs {
                                                              withdraw_amount: self.instruction.withdraw_amount.clone().expect("withdraw_amount is not set"),
                                    };
...
#[derive(Clone, Debug)]
struct ExecuteWithdrawCpiBuilderInstruction<'a, 'b> {
