...
pub const INITIALIZE_DEPOSIT_EXTRA_META_ACCOUNTS_DISCRIMINATOR: [u8; 8] =
    [237, 221, 172, 222, 37, 130, 71, 197];
...
impl InitializeDepositExtraMetaAccounts {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let data = InitializeDepositExtraMetaAccountsInstructionData::new()
            .try_to_vec()
            .unwrap();
