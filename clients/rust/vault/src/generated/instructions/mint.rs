...
impl<'a, 'b> MintCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
    ...
    pub fn user_shares_account(&mut self, user_shares_account: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
      ...
      /// `[optional account]`
#[inline(always)]
    pub fn extra_metas(&mut self, extra_metas: Option<&'b solana_account_info::AccountInfo<'a>>) -> &mut Self {
                        self.instruction.extra_metas = extra_metas;
                    self
    }
      /// `[optional account]`
#[inline(always)]
    pub fn protocol(&mut self, protocol: Option<&'b solana_account_info::AccountInfo<'a>>) -> &mut Self {
                        self.instruction.protocol = protocol;
                    self
    }
      /// `[optional account]`
#[inline(always)]
    pub fn nav_return_data(&mut self, nav_return_data: Option<&'b solana_account_info::AccountInfo<'a>>) -> &mut Self {
    ...
    pub fn share_token_program(&mut self, share_token_program: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
      ...
      #[inline(always)]
    pub fn hook_program(&mut self, hook_program: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
    ...
    pub fn system_program(&mut self, system_program: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
      ...
      /// `[optional account]`
#[inline(always)]
    pub fn instructions(&mut self, instructions: Option<&'b solana_account_info::AccountInfo<'a>>) -> &mut Self {
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_error::ProgramResult {
          let args = MintInstructionArgs {
                                                              shares: self.instruction.shares.clone().expect("shares is not set"),
                                                                  max_assets: self.instruction.max_assets.clone().expect("max_assets is not set"),
                                    };
        ...
        __program: self.instruction.__program,
          ...
          hook_program: self.instruction.hook_program.expect("hook_program is not set"),
